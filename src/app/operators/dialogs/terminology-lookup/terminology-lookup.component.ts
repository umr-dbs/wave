...
const TERMINOLOGIES: Array<{name: string, acronym: string, description: string, uri: string}> = [
    ...
    },
    {
        name: 'RecordBasis',
        acronym: 'RECORDBASIS',
        description: 'A controlled vocabulary (Terminology) \'BasisOfRecords\' or \'RecordBasis\' (DwC: “The specific nature of the data record.”). Based on GBIF/ DwC and BiNHum/ABCD.',
    ...
    },
    {
        name: 'Kingdom',
        acronym: 'KINGDOM',
        description: 'A controlled vocabulary (Terminology) for biological taxa \'Higher Classification - Kingdom (=Regnum)\'. Based on GBIF and CoL.',
    ...
    },
    {
        ...
        acronym: 'LIT_I',
        description: 'The lithologs ontology for igneous rocks provides SKOSified information on the classification of igneous rocks extracted from the IUGS recommendations published by Le Maitre (ed.)(2002): Igneous rocks: a classification and glossary of terms',
    ...
    },
    {
        ...
        acronym: 'PESI',
        description: 'PESI provides standardised and authoritative taxonomic information by integrating and securing Europes taxonomically authoritative species name registers and nomenclators (name databases) and associated exper(tise) networks that underpin the management of biodiversity in Europe.',
        uri: 'http://www.eu-nomen.eu/portal/taxon.php?GUID='
    },
    {
        name: 'World Register of Marine Species',
        acronym: 'WORMS',
        description: 'The aim of a World Register of Marine Species (WoRMS) is to provide an authoritative and comprehensive list of names of marine organisms, including information on synonymy. While highest priority goes to valid names, other names in use are included so that this register can serve as a guide to interpret taxonomic literature.',
 ...
 */
@Component({
    selector: 'wave-terminology-lookup',
